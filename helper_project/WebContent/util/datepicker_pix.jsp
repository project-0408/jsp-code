...
<input type="text" name="job_day" id="timeDay" value="<%=jp.getTime()%>">
<input type="text" name="job_time_start" id="timeStart" value="<%=jp.getJob_time_start()%>">
<input type="text" name="job_time_end" id="timeEnd" value="<%=jp.getJob_time_end()%>">