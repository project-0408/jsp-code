...
<body>
	<form name="bd_frm" action="write_ok.jsp" method="post">
		<table>
			...
			<tr>
				<td>글제목 <input style="width: 350px;" type="text" name="title">
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td><input type="submit" value="작성" onclick="check_ok()">
					<input type="reset" value="다시작성"><input type="button"value="글목록" onclick="javascript:window.location='list.jsp'">
				</td>
			</tr>
		</table>
	</form>
